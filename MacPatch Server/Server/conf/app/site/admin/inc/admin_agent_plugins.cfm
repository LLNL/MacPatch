	...
	$(document).ready(function()
		{
			...
			$("#list").jqGrid(
			{
				url:'admin_agent_plugins.cfc?method=getAgentPlugins', //CFC that will return the users
				...
				caption: 'MacPatch Agent Plugins', //Grid Name
				...
				width:980,
				hidegrid:false,
				editurl:"admin_agent_plugins.cfc?method=editAgentPlugins",//Not used right now.

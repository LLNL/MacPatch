...
-- ----------------------------
--  Table structure for `apple_patches_real`
-- ----------------------------
DROP TABLE IF EXISTS `apple_patches_real`;
CREATE TABLE `apple_patches_real` (
  `rid` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `akey` varchar(50) NOT NULL,
...
-- ----------------------------
--  Table structure for `apple_patches_real_hst`
-- ----------------------------
DROP TABLE IF EXISTS `apple_patches_real_hst`;
CREATE TABLE `apple_patches_real_hst` (
  `rid` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `akey` varchar(50) NOT NULL,
  `postdate` datetime NOT NULL,
  `version` varchar(20) NOT NULL,

            ...
            <li class="yuimenubaritem first-of-type">
                ...
                <div id="admin" class="yuimenu">
                    <div class="bd">
                        ...
                        <ul>
                            <li class="yuimenuitem"><a class="yuimenuitemlabel" href="#">Custom Patches</a>
                                <div id="AdminThirdPartyPatches" class="yuimenu">
                                    <div class="bd">
                                        <ul class="first-of-type">
                                            <li class="yuimenuitem"><a href="index.cfm?adm_mp_patch_list" class="yuimenuitemlabel">List</a></li>
                            				<li class="yuimenuitem"><a href="index.cfm?adm_mp_patch_wizard" class="yuimenuitemlabel">Create New Patch</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>

		...
		<cfloop query="selUsers" startrow="#start#" endrow="#end#">
			...
			<cfloop list="#arguments.orderedCols#" index="col" delimiters=",">
				...
				<cfif col EQ "cdate" OR col EQ "mdate" OR col EQ "sdate" OR col EQ "date"> 
					...
					<!---<cfset _dts = #DateFormat(evaluate(col), "yyyy-mm-dd")# & " " & #TimeFormat(evaluate(col), "HH:mm:ss")#>--->
            ...
            <cfif hasHWData EQ true>
            	...
            	<!--- <cfset arrUsers[i] = [#cuuid#,#hostname#,#computername#,#serialNo#,#ipaddr#,#macaddr#,#osver#,#ostype#,#consoleUser#,#needsreboot#,#agent_version#,#client_version#,#Domain#,#PatchGroup#,#mdate#]> --->
			<cfelse>
				<cfset _arr = ArrayAppend(arrUsers,_dataArr)>
            	<!--- <cfset arrUsers[i] = [#cuuid#,#hostname#,#computername#,#serialNo#,#ipaddr#,#macaddr#,#osver#,#ostype#,#consoleUser#,#needsreboot#,#agent_version#,#client_version#,#Domain#,#PatchGroup#,#mdate#]> --->
            </cfif>  

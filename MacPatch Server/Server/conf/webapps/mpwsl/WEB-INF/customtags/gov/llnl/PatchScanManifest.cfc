...
<cfcomponent>
	...
	<cffunction name="xlog" access="public" returntype="any" output="no">
		<cfargument name="logText" required="no" default="Production">
		<cfinvoke component="ws_logger" method="LogEvent">
            ...
            <cfinvokeargument name="aEvent" value="#arguments.logText#">
        </cfinvoke>
	</cffunction>

...
MODS=('pip-7.1.0' 'argparse-1.3.0' 'mysql-connector-python-2.0.4' 'requests-2.7.0' 'biplist-0.9' 'wheel-0.24.0' 'six-1.9.0' 'python-dateutil-2.4.2' 'python-crontab-1.9.3');

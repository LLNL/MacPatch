	...
	$(document).ready(function()
		{
			...
			{
				url:'./includes/installed_patches.cfc?method=getInstalledPatches', //CFC that will return the users
				...
				pginput:true,
				width:980,
				editurl:"includes/installed_patches.cfc?method=addEditInstalledPatches",//Not used right now.
				toppager:false,
				hidegrid:false,
				jsonReader: {
					total: "total",

...
<cfsavecontent variable="newConfig">
  <nocfml><cfoutput>
    ...
    <cfform action="index.cfm?agent_config&action=0" method="Post" name="AddNewAgentConfig">
		<fieldset>
		...
		<fieldset>
			...
			<tr><td>
				...
				<input class="button medium gray" type="button" value="Cancel" onclick="this.form.submit();">
...
<cfsavecontent variable="editConfig">
  <nocfml><cfoutput>
    ...
    <cfform action="index.cfm?agent_config&action=1" method="Post" name="EditAgentConfig">
		<fieldset>
    	<legend>Config Name:</legend>
			<table border="0" class="tbltask">
...
<tr>
	<td>#name#</td>
	<td align="center"><cfif isDefault EQ 0><a href="index.cfm?agent_config&config=<cfoutput>#aid#</cfoutput>&action=3"><img src="/admin/_assets/images/icons/table_gear.png"></a><cfelse><img src="/admin/_assets/images/icons/bullet_green.png"></cfif></td>
    <td align="center"><a href="index.cfm?agent_config&config=<cfoutput>#aid#</cfoutput>&action=4"><img src="/admin/_assets/images/icons/cog_edit.png"></a></td>
    <td align="center"><a href="index.cfm?agent_config&config=<cfoutput>#aid#</cfoutput>&action=2"><img src="/admin/_assets/images/icons/cog_delete.png"></a></td>
</tr>
</cfoutput>
</TBODY>
</table>

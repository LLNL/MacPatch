...
<SCRIPT LANGUAGE="JavaScript">
    ...
    function showSoftwareList(frmEleName) {
      sList = window.open("./includes/sw_dist/sw_dist_picker.cfm?INName="+frmEleName, "list", "width=400,height=500");
    }
    
    function showPatchList(frmEleName) {
      sList = window.open("./includes/sw_dist/sw_patch_bundle_picker.cfm?INName="+frmEleName, "list", "width=400,height=500");
    }
...
<script type="text/javascript">
    function addFormField(frmFieldName, pid, divid) {
        ...
        $("#"+divid).append("<p id='row" + frmFieldName + id +"' style='margin-top:4px;'>"+rmRef+"&nbsp;<img src='./_assets/images/info.png' style='vertical-align:middle;' height='14' width='14' onClick=\"showSoftwareList('"+frmFieldName+":"+id+"')\;\">&nbsp;<input type='text' size='50' name='pName" + frmFieldName + ":" + id + "' id='pName" + frmFieldName + ":" + id +"' disabled><input type='hidden' size='20' name='" + frmFieldName + "_" + id + "' id='"+frmFieldName + id +"'>&nbsp;<input type='text' name='"+frmFieldName+"Order_"+id+"' value='"+id+"' size='4'>(Order)&nbsp;<p>");
    }
            ...
            <div id="row">
              ...
              <div id="center">
                ...
                <div style="font-size:10px;padding:10px;">
                	<cfoutput>
                	<a href="http://#CGI.SERVER_NAME#/mp-content#selSwDist.sw_url#" style="font-size:10px;color:ffffff;"><img src="./_assets/images/icons/arrow_down.png" height="14" />#ListLast(selSwDist.sw_url,"/")# (#selSwDist.sw_hash#)</a>
                	</cfoutput>
                </div>
              </div>
              ...
              <cfif #selSwDistReq.type# EQ "0">
                <cfoutput>
                  ...
                  <p id="rowprePatchPKG#selSwDistReq.type_order#" style="margin-top:4px;">
                    <img onClick='removeFormField("##rowprePatchPKG#selSwDistReq.type_order#"); return false;' src="./_assets/images/cancel.png" style="vertical-align:middle;" height="14" width="14"> <img src='./_assets/images/info.png' style='vertical-align:middle;' height='14' width='14' onClick="showSoftwareList('prePatchPKG:#selSwDistCri.type_order#');">
                  ...
                  <cfif #selSwDistReq.type# EQ "1">
                    <cfoutput>
                      <p id="rowpostPatchPKG#selSwDistReq.type_order#" style="margin-top:4px;">
                        <img onClick='removeFormField("##rowpostPatchPKG#selSwDistReq.type_order#"); return false;' src="./_assets/images/cancel.png" style="vertical-align:middle;" height="14" width="14"> <img src='./_assets/images/info.png' style='vertical-align:middle;' height='14' width='14' onClick="showSoftwareList('postPatchPKG:#selSwDistCri.type_order#');">

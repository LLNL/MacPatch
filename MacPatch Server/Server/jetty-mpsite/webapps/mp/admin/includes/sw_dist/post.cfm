...
<cfset BaseSWPath = "/Library/MacPatch/Content/Web/sw">
...
<!---
<cfif cffile.clientfileext NEQ "zip" OR cffile.clientfileext EQ "dmg">
...
<cfif cffile.clientfileext == "zip" || cffile.clientfileext EQ "dmg">

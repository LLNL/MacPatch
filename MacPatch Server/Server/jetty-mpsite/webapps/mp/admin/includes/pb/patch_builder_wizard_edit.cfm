...
<cfquery name="selPatchReq" datasource="#session.dbsource#">
    ...
    Where mp_patches_requisits.puuid = '#patchID#'
    Order By type_order Asc
</cfquery>
...
<cfif IsDefined("isReadOnly") IS false>
  ...
  <cfset action="./includes/pb/update.cfm">
  <cfelse>
  <cfset action="">
</cfif>

<cfform name="stepIt" method="post" action="#action#" enctype="multipart/form-data">
  <cfinput type="hidden" name="puuid" value="#patchID#">
            ...
            <cfloop query="selPatchCri">
              <cfif selPatchCri.type_order GTE orderTypeSize>
                <cfoutput>
					...
					<span style='vertical-align:top;'>(Order)</span>&nbsp; <a href='##' onClick='removeFormField("##rowreqPatchCriteria#xi#"); return false;'><img src='./_assets/images/cancel.png' style='vertical-align:top;margin-top:2px;' height='14' width='14'></a></p>
                </cfoutput>
				<cfset xi = xi + 1>
              </cfif>
            </cfloop>
            ...
            <div id="row">
              ...
              <div id="center">
                ...
                <div style="font-size:10px;padding:10px;">
                	<cfoutput>
                	<a href="http://#CGI.SERVER_NAME#/mp-content#selPatch.pkg_url#" style="font-size:10px;color:ffffff;"><img src="./_assets/images/icons/arrow_down.png" height="14" />#selPatch.pkg_name# (#selPatch.pkg_hash#)</a>
                	</cfoutput>
                </div>
              </div>
              ...
              <cfif #selPatchReq.type# EQ "0">
                <cfoutput>
                  ...
                  <p id="rowprePatchPKG#selPatchReq.type_order#" style="margin-top:4px;">
					<img onClick='removeFormField("##rowprePatchPKG#selPatchReq.type_order#"); return false;' src="./_assets/images/cancel.png" style="vertical-align:middle;" height="14" width="14"> <img src='./_assets/images/info.png' style='vertical-align:middle;' height='14' width='14' onClick="showList('prePatchPKG:#selPatchCri.type_order#');">
              ...
              <cfif #selPatchReq.type# EQ "1">
                <cfoutput>
                  <p id="rowpostPatchPKG#selPatchReq.type_order#" style="margin-top:4px;">
					<img onClick='removeFormField("##rowpostPatchPKG#selPatchReq.type_order#"); return false;' src="./_assets/images/cancel.png" style="vertical-align:middle;" height="14" width="14"> <img src='./_assets/images/info.png' style='vertical-align:middle;' height='14' width='14' onClick="showList('postPatchPKG:#selPatchCri.type_order#');">

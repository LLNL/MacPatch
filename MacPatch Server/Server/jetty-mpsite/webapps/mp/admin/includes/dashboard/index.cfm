...
h3 {font-size:16px; font-weight:bold; padding:6px;
...
<cfquery datasource="#session.dbsource#" name="qGetAVInfo">
   	SELECT	defsDate, Count(defsDate) As Count
    FROM	savav_info
    
    LEFT 	JOIN mp_clients_view ci
	ON 		savav_info.cuuid=ci.cuuid
    Where 0=0
...
<!---
<cfoutput>
<script src="./includes/dashboard/Scripts/AC_RunActiveContent.js" type="text/javascript"></script>
</cfoutput>
--->
<table align="center">
	<tr>
		<td>
            <table align="center">
            	<tr>
                    <td colspan="2"><h3>Total Clients - <cfoutput>#qGetTotalClient.Total#</cfoutput></h3></td>
                </tr>    
                <tr>
                    ...
                    <div id="dashbox">
                            <div id="av1" style="display:inline;">
                                ...
                                <table id="avTable" class="tablesorter" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
                                        <th width="26">&nbsp;</th>
                                        <th>AV Defs Date</th>
                                    ...
                                    <tr>
                                        <td><a href="index.cfm?dashboard=True&Series=AVInfo&Item=#defsDate#"><img src="./_assets/images/info.png" height="16" width="16"></a></td>
                                        <td>#defsDate#</td>
                                        <td>#count#</td>
                                    </tr>		
                                    </cfoutput>
                            ...
                            <div id="av2" style="display:none;">
                            	<cfquery datasource="#session.dbsource#" name="qGetAVVersionData">
                                    select savShortVersion, count(*) as total 
                                    From savav_info
                                    LEFT 	JOIN mp_clients_view ci
                                    ON savav_info.cuuid=ci.cuuid
                                    Where 0 = 0 AND ci.cuuid IS NOT NULL
                                    Group By savShortVersion
                                    Order By total Desc 
                                </cfquery>
                                ...
                                url="index.cfm?dashboard=True&Series=AVVersionInfo&Item=$ITEMLABEL$" >
                                    <cfchartseries type="pie" serieslabel="AV Version Break Down">
                                    <cfoutput query="qGetAVVersionData">
                                        <cfchartdata item="#savShortVersion#" value="#total#">
                                    </cfoutput>
                                    </cfchartseries>
                                </cfchart>
                            </div>
                            <div id="av3" style="display:none;">
                                <cfquery datasource="#session.dbsource#" name="qGet">
                                    select IF( av.savShortVersion IS NULL, "no", "yes") as AVClient, count(*) total
                                    From mp_clients_view cci
                                    Left Join savav_info av
                    ...
                    <td class="style0" valign="top">
                    		...
                    		<table id="npTable" class="tablesorter" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th>Patch</th>
                                <th>Version</th>
                ...
                <tr>
                    <td class="style0">
                    	<div id="dashbox">
                            ...
                            <cfchart format="png" title="OS Break Down" showlegend="no" showborder="no" chartheight="400" chartwidth="480" xaxistitle="OS Versions" yaxistitle="Client Count" url="index.cfm?dashboard=True&Series=$SERIESLABEL$&Item=$ITEMLABEL$">
                            ...
                            <div id="os2" style="display:inline;">
                                <cfchart format="png" title="OS Break Down Minor" showlegend="no" chartheight="400" chartwidth="480" xaxistitle="Model Type" yaxistitle="Count" url="index.cfm?dashboard=True&Series=$SERIESLABEL$&Item=$ITEMLABEL$">
							...
							<div id="os3" style="display:none;">
                                <cfchart format="png" title="Top 10 Model Types" showlegend="no" chartheight="400" chartwidth="480" xaxistitle="Model Type" yaxistitle="Count" url="index.cfm?dashboard=True&Series=$SERIESLABEL$&Item=$ITEMLABEL$">
                            ...
                            <div id="os4" style="display:none;">
                                <cfchart format="png" title="OS Type Break Down" showlegend="no" chartheight="400" chartwidth="480" xaxistitle="Model Type" yaxistitle="Count" url="index.cfm?dashboard=True&Series=$SERIESLABEL$&Item=$ITEMLABEL$">
                    ...
                    <td class="style0">
                        <cfchart format="png" title="Top 10 Outstanding Patches" showlegend="no" showborder="no" chartheight="400" chartwidth="480" url="index.cfm?dashboard=True&Series=$SERIESLABEL$&Item=$ITEMLABEL$" yaxistitle="Patch Count">
			...
			<table align="center">     
                <tr>
                    <td class="style0">	
                    <cfchart pieSliceStyle="sliced" show3d="yes"  format="png" title="Client Checkin Status" showlegend="no" showborder="no" chartheight="220" chartwidth="480" url="index.cfm?dashboard=True&Series=$SERIESLABEL$&Item=$ITEMLABEL$">
                    ...
                    <td class="style0">
                    <cfchart pieSliceStyle="sliced" show3d="yes" format="png" title="Clients Needing Reboot" showlegend="no" showborder="no" chartheight="220" chartwidth="480" url="index.cfm?dashboard=True&Series=$SERIESLABEL$&Item=$ITEMLABEL$">
...
<cfif IsDefined("url.Series") and url.Series EQ "AVInfo">
	<cfquery datasource="#session.dbsource#" name="qMoreInfo" cachedwithin="#CreateTimeSpan(0, 0, 0, 15)#">
		SELECT	sav.defsDate, sav.savShortVersion, sav.savAppName, sav.mdate, ci.hostname, ci.mdate as cmdate, ci.Domain as ClientGroup, ci.ipaddr
		FROM	savav_info sav
		LEFT 	JOIN mp_clients_view ci
		ON sav.cuuid=ci.cuuid
		Where 0=0
		<cfif IsDefined("session.cgrp") and ListLen(session.cgrp,",") GTE 1>
            AND
            ci.Domain IN (#ListQualify(session.cgrp,"'",",","CHAR")#)
        </cfif>
        AND defsDate like '#Url.Item#'
	...
	<div style="float: right; padding-bottom:6px;">
		<img src="./_assets/images/icons/table_save.png" title="Export to CSV" align="left" onClick="window.open('includes/dashboard/dashboard_export.cfm','Export2CSV');">Export (CSV)&nbsp;
	</div>
	<table id="avInfoTable" class="tablesorter" border="0" cellpadding="0" cellspacing="0" width="100%">
		<thead>
        <tr>
            <th>HostName</th>
            <th>IP Address</th>
...
<cfif IsDefined("url.Series") and url.Series EQ "AVVersionInfo">
	<cfquery datasource="#session.dbsource#" name="qMoreInfo" cachedwithin="#CreateTimeSpan(0, 0, 0, 15)#">
        ...
        AND savShortVersion like '#Url.Item#'
        AND ci.cuuid IS NOT NULL
	</cfquery>
	<cfset session.DashboardExportQuery = qMoreInfo>
	<div style="float: left;"><h4>AV Info - Drill Down (<cfoutput>#Url.Item#</cfoutput>)</h4></div>
...
<cfif IsDefined("url.Series") and url.Series EQ "OSBreakDown">
    ...
    <table id="tSorter" class="tablesorter" border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
		<thead>
        <tr>
        	<th>ClientID</th>
            <th>HostName</th>
...
<cfelseif IsDefined("url.Series") and url.Series EQ "NeedsReboot">
    ...
    <table id="tSorter" class="tablesorter" border="0" cellpadding="0" cellspacing="0" width="100%">
		<thead>
        <tr>
            <th>HostName</th>
            <th>IP Address</th>

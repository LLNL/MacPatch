...
{
    NSGradient *gradient = [[NSGradient alloc] initWithStartingColor:[NSColor darkGrayColor] endingColor:[NSColor blackColor]];
    //[gradient drawInRect:windowFrame angle:90];
    [gradient drawFromPoint:	NSMakePoint(0,0)
                    toPoint:		NSMakePoint(0,self.frame.size.height)

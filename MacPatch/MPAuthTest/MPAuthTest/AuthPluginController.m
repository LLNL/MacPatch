...
- (void)sendInfoToField:(NSString *)aMsg
{
    [progressCountText setStringValue:aMsg];
...
- (void)scanAndPatch
{
    ...
    [self performSelectorOnMainThread:@selector(scanHostForPatches) withObject:nil waitUntilDone:NO];
}
...
- (void)scanHostForPatches
{
    @autoreleasepool
    {
        ...
        for (i = 0; i < [approvedPatches count]; i++)
        {
            ...
            [self performSelectorOnMainThread:@selector(sendInfoToField:) withObject:@"Install it ...." waitUntilDone:NO];

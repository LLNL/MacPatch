...
#ifndef LCLLogFile
#define LCLLogFile                                                             \
    ExampleAppLCLLogFile
#endif

// Tell LCLLogFile the path of the log file.
//[MP_ROOT stringByAppendingPathComponent:@"Client/Logs/swupd.log"]
//#define _LCLLogFile_LogFilePath /* (NSString *) */                             \
//    [NSHomeDirectory() stringByAppendingPathComponent:@"Library/Logs/MPStatus.log"]

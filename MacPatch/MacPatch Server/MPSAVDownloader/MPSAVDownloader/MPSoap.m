...
{	
	...
	if ([MPNetUtils pingHostWithPort:[theURL host] port:[[theURL port] intValue]] == NO) {
		qlinfo(@"Unable to reach %@.",[theURL host]);
		[errorDetail setValue:[NSString stringWithFormat:@"Error trying to reach server."] forKey:NSLocalizedDescriptionKey];

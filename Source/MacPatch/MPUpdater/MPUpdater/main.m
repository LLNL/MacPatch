...
int main(int argc, char * argv[])
{
	@autoreleasepool
	{
		...
		while (1)
		{
			...
			int option_index = 0;
			c = getopt_long (argc, argv, "sueVvh", long_options, &option_index);
		...
		// Run Functions
		MPUpdaterController *updater = [MPUpdaterController new];
		switch (a_Type)
		{
			case 1:
				[updater scanForUpdate];
				break;
			case 2:
				[updater scanAndUpdate];
				break;
			default:
				[updater scanForUpdate];
				break;

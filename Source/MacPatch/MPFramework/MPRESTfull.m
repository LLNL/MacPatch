...
- (NSDictionary *)getApprovedPatchesForClient:(NSError **)err
{
    ...
    NSString *urlPath = [NSString stringWithFormat:@"/api/v2/client/patch/group/%@",self.ccuid];
...
- (NSArray *)getSoftwareTasksForGroup:(NSString *)groupName error:(NSError **)err
{
    ...
    NSString *urlPath = [NSString stringWithFormat:@"/api/v2/sw/tasks/%@/%@",self.ccuid, groupName];

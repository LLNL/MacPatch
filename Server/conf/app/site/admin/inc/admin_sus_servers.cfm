	...
	$(document).ready(function()
		{
			...
			$("#list").jqGrid(
			{
				url:'admin_sus_servers.cfc?method=getSUServers', //CFC that will return the users
				datatype: 'json', //We specify that the datatype we will be using will be JSON
				colNames:['','CatalogURL', 'OS Major', 'OS Minor', 'Proxy', 'Active'],
				colModel :[
				  {name:'rid',index:'rid', width:1, align:"center", sortable:false, hidden:true},
				  {name:'catalog_url', index:'catalog_url', width:200, editable:true, editoptions:{size:150}},
				  {name:'os_major', index:'os_major', width:40, editable:true, formoptions:{align: 'left'}},
				  {name:'os_minor', index:'os_minor', width:40, editable:true, formoptions:{align: 'left'}},
				...
				caption: 'Software Update Servers', //Grid Name
				...
				width:980,
				hidegrid:false,
				editurl:"admin_sus_servers.cfc?method=editSUServers",//Not used right now.

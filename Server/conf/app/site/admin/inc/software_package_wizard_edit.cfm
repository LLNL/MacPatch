          ...
          <div id="container">
            ...
            <div id="row">
              ...
              <div id="center">
                ...
                <cfoutput>
                  <option value="packageZip" #IIf(selSwDist.sw_type is "packageZip", DE("Selected"), DE(""))#>ZIP/Package (pkg/mpkg)</option>
                  <option value="scriptZip" #IIf(selSwDist.sw_type is "scriptZip", DE("Selected"), DE(""))#>ZIP/Script</option>
                  <option value="appZip" #IIf(selSwDist.sw_type is "appZip", DE("Selected"), DE(""))#>ZIP/Application</option>
